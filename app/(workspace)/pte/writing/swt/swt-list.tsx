        ...
        {initialQuestions.map((item, index) => {
          return (
            <Link
              ...
              onClick={() => {
                saveQuestionOrder("swt", questionIds);
              }}
              className="block"
            >
                ...
                <div className="relative">
                  ...
                  <div className="pte-practice-card-body relative flex items-start justify-center gap-5 px-5 py-4 sm:px-6">
                    <div className="pte-practice-card-content w-full max-w-3xl">
                      ...
                      <PteEnglishTitle title={item.question_title} className="pte-practice-title text-[15px] font-medium leading-7 tracking-[0.01em] text-[var(--text)] transition-colors duration-300 sm:text-[16px] sm:leading-8" />
