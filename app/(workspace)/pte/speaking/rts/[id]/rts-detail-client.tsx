...
export default function RtsDetailClient({ question }: Props) {
  ...
  const questionNav = usePteQuestionNavigation("rts", question.id);
  ...
  return (
    <div className="mt-8 space-y-6">
      ...
      <PteQuestionNavigationControls key={question.id} navigation={questionNav} routeBase="/pte/speaking/rts" audioProfile={{ kind: "source", questionType: "rts" }} />
    </div>
  );
}
