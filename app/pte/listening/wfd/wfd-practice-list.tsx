                                        ...
                                        <div className="rounded-2xl border border-gray-200 bg-[#faf8f4] p-4">
                                            <div className="mb-4 flex flex-wrap items-center gap-3">
                                                {item.audio_url ? (
                                                    ...
                                                    <button
                                                        type="button"
                                                        className="cursor-pointer inline-flex items-center justify-center rounded-2xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-semibold text-gray-600"
                                                    >
                                                        播放音频
                                                    </button>
                                                )}
...
//   const result: { type: "correct" | "missing" | "extra"; text: string }[] = [];
...
//     if (u === c && u) {
//       result.push({ type: "correct", text: c });
//     } else {
//       if (c) result.push({ type: "missing", text: c });
//       if (u) result.push({ type: "extra", text: u });
//     }
//   }
...
//                 <div className="min-w-0 flex-1">
//                   <div className="mb-3 flex flex-wrap items-center gap-2">
//                     <span className="inline-flex items-center rounded-lg bg-[var(--theme)]/10 px-2.5 py-1 text-xs font-medium text-[var(--theme)]">
//                       WFD
//                     </span>
...
//                   {open ? (
//                     <div className="mt-5 rounded-2xl border border-gray-200 bg-[#faf8f4] p-4">
//                       <div className="mb-4 flex flex-wrap items-center gap-3">
//                         {item.audio_url ? (
//                           <audio controls className="w-full max-w-xl">
//                             <source src={item.audio_url} />
...
//                           <button
//                             type="button"
//                             className="inline-flex items-center justify-center rounded-2xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-semibold text-gray-600"
//                           >
//                             播放音频
//                           </button>
//                         )}
...
//                           onClick={() => handleSubmit(item)}
//                           disabled={loadingId === item.id}
//                           className="inline-flex items-center justify-center rounded-2xl bg-[var(--theme)] px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:opacity-95 disabled:opacity-60"
//                         >
//                           {loadingId === item.id ? "提交中..." : "确认答案"}
//                         </button>
//                       </div>
...
//                     type="button"
//                     onClick={() => handleStart(item.id)}
//                     className="rounded-2xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-semibold text-gray-600 transition hover:border-[var(--theme)]/30 hover:text-[var(--theme)]"
//                   >
//                     {open ? "正在练习" : "开始练习"}
//                   </button>
//                 </div>
...
// }: {
//   children: React.ReactNode;
//   tone?: "theme" | "green" | "purple" | "yellow" | "pink" | "blue" | "warm" | "neutral";
// }) {
//   const styles = {
//     theme: "bg-[var(--theme)]/10 text-[var(--theme)]",
//     green: "bg-emerald-50 text-emerald-700",
...
//                   <p
//                     className={`text-[17px] leading-8 sm:text-[19px] transition ${
//                       practiceMode === "test"
//                         ? "select-none text-gray-400 blur-[5px]"
//                         : "text-gray-800"
//                     }`}
//                     aria-label={practiceMode === "test" ? "题目已模糊显示" : item.question_text}
//                   >
//                     {item.question_text}
//                   </p>
