...
import { createAchievementEngineContext, getHighestUnlockedCategoryLevel } from "@/lib/achievements/engine";
...
export async function GET() {
  try {
    ...
    return NextResponse.json({ ...overview, overall_achievement_title: overallLevel?.title ?? null });
  } catch (error) {
