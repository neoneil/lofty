...
import { COURSE_GRADIENT_PRESETS, type CourseGradientPreset } from "./course-gradient-presets";
...
export default function CourseGradientTools({ expanded, showCollapsed, onExpandedChange }: CourseGradientToolsProps) {
  ...
  function applyPreset(preset: CourseGradientPreset) {
  ...
  function getPresetBackground(preset: CourseGradientPreset) {
