...
export function PteMockWritingQuestion({ question }: { question: PteMockQuestion }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <Textarea value={answer} onChange={(event) => setAnswer(event.target.value)} placeholder={isSwt ? "Write one sentence..." : "Write your essay..."} className={isSwt ? "min-h-36" : "min-h-[320px]"} />
